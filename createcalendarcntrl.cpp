...
//=============================================================================
//message processing handles
LRESULT CALLBACK WndProc(HWND,UINT,WPARAM,LPARAM);
int OnCreate(const HWND,CREATESTRUCT*);

//non-message function declarations
HWND CreateMonthCalendar(const HWND,const HINSTANCE,DWORD,const RECT&,
                         const int);
...
HWND hwnd=CreateWindowEx(0,                     //extended styles
                         ...
                         _T("Common Controls - Month Calendar"), //wnd title
...
//window creation
RECT rc={20,20,190,160};  
StartCommonControls(ICC_DATE_CLASSES); 

CreateMonthCalendar(hwnd,cs->hInstance,0,rc,IDC_MONTHCAL);

return 0;
}
//=============================================================================
HWND CreateMonthCalendar(const HWND hParent,const HINSTANCE hInst,
                         DWORD dwStyle,const RECT& rc,const int id)
{
dwStyle|=WS_CHILD|WS_VISIBLE;
return CreateWindowEx(0,                  //extended styles
                      MONTHCAL_CLASS,     //control 'class' name
                      0,                  //control caption
                      dwStyle,            //wnd style
