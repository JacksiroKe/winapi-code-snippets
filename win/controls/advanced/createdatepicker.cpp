...
HWND CreateDateTimePicker(const HWND,const HINSTANCE,DWORD,const RECT&,
                          const int);
...
HWND hwnd=CreateWindowEx(0,                     //extended styles
                         ...
                         _T("Common Controls - DateTime Picker"), //wnd title
...
CreateDateTimePicker(hwnd,cs->hInstance,0,rc,IDC_DATETIMEPICKER);

return 0;
}
//=============================================================================
HWND CreateDateTimePicker(const HWND hParent,const HINSTANCE hInst,
